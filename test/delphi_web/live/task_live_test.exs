defmodule DelphiWeb.TaskLiveTest do
  use DelphiWeb.ConnCase

  import Phoenix.LiveViewTest
  import Delphi.TasksFixtures

  @create_attrs %{completed: true, description: "some description", duration: 42, name: "some name", when: "2023-06-04T00:26:00"}
  @update_attrs %{completed: false, description: "some updated description", duration: 43, name: "some updated name", when: "2023-06-05T00:26:00"}
  @invalid_attrs %{completed: false, description: nil, duration: nil, name: nil, when: nil}
